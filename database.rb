...
class WADatabase
	def self.connect(database)
		...
		dbase = Mysql2::Client.new(:host => "alpenight.cfbj3gqajo97.ap-southeast-2.rds.amazonaws.com", :username => 'jaxen', :password => '54CheritonStreet', :database => 'election_night', :flags => Mysql2::Client::MULTI_STATEMENTS)
		#gateway.close(sshtunnel)
		return dbase
	end
